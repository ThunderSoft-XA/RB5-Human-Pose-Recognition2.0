...
public class MainActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initResourceFile() {
        ...
        moveAssetToPath("openpose_body25.dlc", SAVE_PATH);
    ...
    class AIStartThread extends Thread {
        ...
        public void run() {
            ...
            if (GlobalConfig.ENABLE_HUMANPOSERECOGNITION) {
                HumanPoseRecognitionTask.getHumanPoseRecognitionTask().init(getApplication(),
                        idList,
                        fragmentManageList,
...
//                    startActivity(new Intent(MainActivity.this, SettingActivity.class));
    ...
    private void stopAIService() {
        if (GlobalConfig.ENABLE_HUMANPOSERECOGNITION) {
            HumanPoseRecognitionTask.getHumanPoseRecognitionTask().closeService();
        }
    ...
    private PlayFragment createPlayFragment(int index) {
        if (DeviceCollection.getAlgorithmType(index, Constants.ENABLE_HUMANPOSERECOGNITION_STR)) {
            return new HumanPoseRecognitionFragment(index);
        }
